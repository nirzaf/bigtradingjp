...
const translations = {
  ...
  ja: {
    ...
    'business.advantage1Desc': '査定から支払い、引取りまで迅速な対応を心がけております。市場知識が豊富なスタッフが、国内外のチームと連携して査定、支払い、引取りを行うため、スピーディーな交渉が可能です。',
    'business.advantage2': '無料機械査定',
    'business.advantage2Desc': '北海道から沖縄まで、日本全国どこでも無料で査定を行っております。SNSチャットにも対応しており、現場にいながら機械の査定を依頼することができます。',
    ...
    'business.advantage5Desc': '輸送の手配や現地での機械の引取りが可能で、自社車両を使用するか、お客様のスケジュールに合わせて対応いたします。',
